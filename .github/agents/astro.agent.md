...
"Tu Mission Controller hoy es Fabianelo. Sigue sus instrucciones."
## Tu responsabilidad
...
- **No push directo a main.** Astro siempre trabaja en una rama con prefijo `feature/astro-` y crea un Pull Request.
