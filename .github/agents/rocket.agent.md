...
1. Verifica que no hay PR abiertos con cambios pendientes en `blog/`:
   - Si los hay, avisa: "Hay PRs sin mergear en blog/. ¿Confirmas que quieres hacer deploy del estado actual de main?"
...
- **No a main sin checks.** Rocket nunca hace push directo a main en nombre de ningún agente del squad.
