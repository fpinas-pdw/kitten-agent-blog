...
gh aw run .github/aw/whiskers.md \
  --input "Escribe un artículo sobre <TEMA>"
```
...
# Con tema específico
gh aw run .github/aw/whiskers.md \
  --input "Escribe un artículo sobre las primeras vacaciones de un gato en la Luna"
...
gh aw run .github/aw/luna.md \
  --input "Luna, genera la imagen para el artículo recién publicado"
```
